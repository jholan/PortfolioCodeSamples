...
std::vector<std::string> Profiler_GenerateFlatReportFromTree(ReportNode* tree, eFlatReportSortMode sortMode) {UNUSED(tree); UNUSED(sortMode); return std::vector<std::string>();}
std::vector<std::string> Profiler_GenerateNestedReportFromTree(ReportNode* tree) {UNUSED(tree); return std::vector<std::string>();}
