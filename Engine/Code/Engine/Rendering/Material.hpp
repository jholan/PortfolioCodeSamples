...
public:
	...
	// Textures
	void				 SetTexture(unsigned int bindPoint, const std::string& filepath, TextureSamplerType samplerType = TEXTURE_SAMPLER_TYPE_LINEAR);
	void				 SetTexture(unsigned int bindPoint, const Texture*	   texture,	 TextureSamplerType samplerType = TEXTURE_SAMPLER_TYPE_LINEAR);
						 
	void				 SetDiffuseTexture(const std::string& filepath, TextureSamplerType samplerType = TEXTURE_SAMPLER_TYPE_LINEAR);
	void				 SetDiffuseTexture(const Texture*	  texture,  TextureSamplerType samplerType = TEXTURE_SAMPLER_TYPE_LINEAR);
						 
	void				 SetNormalMap(const std::string&	  filepath, TextureSamplerType samplerType = TEXTURE_SAMPLER_TYPE_LINEAR);
