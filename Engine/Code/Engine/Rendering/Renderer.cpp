...
void BindGLFunctions()
{
	...
	GL_BIND_FUNCTION(glGetFramebufferAttachmentParameter);
...
void Renderer::Initialize()
{
	...
	m_defaultColorTarget = Texture::CreateRenderTarget(windowDimensions.x, windowDimensions.y, Texture::TEXTURE_FORMAT_RGBA16F);
	m_defaultDepthTarget = Texture::CreateRenderTarget(windowDimensions.x, windowDimensions.y, Texture::TEXTURE_FORMAT_D24S8);
	...
	m_screenEffectScratchTarget = Texture::CreateRenderTarget(windowDimensions.x, windowDimensions.y, Texture::TEXTURE_FORMAT_RGBA16F);
}
