...
void AttractState::Initialize(Game* owner)
{
	...
	m_backgroundMaterial->SetDiffuseTexture(g_gameConfigBlackboard.GetValue("attractStateBackground", "Data/BuiltIns/DEFAULT_TEXTURE.png"), Texture::TEXTURE_FORMAT_RGBA8, TEXTURE_SAMPLER_TYPE_POINT);
