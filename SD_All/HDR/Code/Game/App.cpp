...
//------------------------------------------------------------------------
void SaveScreenshot_ThreadFunction(void* data)
{
	Image* image = (Image*)data;

	image->WriteToFile("Screenshots/Screenshot.png");
	image->WriteToFile("Screenshots/Screenshot.png", false);
...
void App::Update(float deltaSeconds)
{
	...
	if (!g_theDevConsole->IsOpen())
	{
		...
		if (g_theInput->WasKeyJustPressed(InputSystem::KEY_F11))
		{
			...
			//Image* i = new Image();
			//*i = g_theRenderer->GetDefaultColorTarget()->CopyToImage();
			//Thread_CreateAndDetach(SaveScreenshot_ThreadFunction, (void*)i);
		}
	}
