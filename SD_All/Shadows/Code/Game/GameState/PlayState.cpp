...
void PlayState::Initialize(Game* owner)
{
	...
	m_fullScreenCamera->SetColorTarget(g_theRenderer->GetDefaultColorTarget());
	...
	m_sceneCamera->SetColorTarget(g_theRenderer->GetDefaultColorTarget());
	...
	m_debugCamera->SetColorTarget(g_theRenderer->GetDefaultColorTarget());
	...
	c1Cam->SetColorTarget(g_theRenderer->GetDefaultColorTarget());
	...
	c2Cam->SetColorTarget(g_theRenderer->GetDefaultColorTarget());
	...
	c3Cam->SetColorTarget(g_theRenderer->GetDefaultColorTarget());
...
int  cameraLayerShown = 2;
int  cameraLayerHidden = 0;
