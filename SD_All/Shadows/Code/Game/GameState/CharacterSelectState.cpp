...
void CharacterSelectState::Initialize(Game* owner)
{
	...
	m_backgroundMaterial->SetDiffuseTexture(g_gameConfigBlackboard.GetValue("characterSelectStateBackground", "Data/BuiltIns/DEFAULT_TEXTURE.png"), TEXTURE_SAMPLER_TYPE_POINT);
